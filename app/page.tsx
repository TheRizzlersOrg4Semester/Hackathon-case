  ...
  return (
    <div className="ui-page-stack">
      ...
      <section className="landing-panel p-6 md:p-8">
        ...
        <p className="mt-2 type-body-sm text-secondary">Scroll the lane or let it glide to explore how the platform works.</p>

        <div className="landing-how-it-works-scroller mt-5">
            ...
            <div className="landing-how-it-works-track">
              {[...howPulseFundWorksItems, ...howPulseFundWorksItems].map((item, index) => {
                ...
                return (
                  <article
                    aria-hidden={isClone}
                    className="landing-how-it-works-card rounded-2xl border border-white/20 bg-white/5 p-5"
                    key={`${item.title}-${isClone ? "clone" : "primary"}`}
                  >
                    <div className="space-y-3">
                      <h3 className="type-card text-white">{item.title}</h3>
                      <p className="type-body-sm leading-6 text-slate-200">{item.text}</p>
                    </div>
