    ...
    <section className="ui-section-stack">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="space-y-2">
          <p className="type-meta">PulseFund Policy</p>
          <h1 className="type-section">Terms of Service</h1>
      ...
      <div className="grid gap-4">
        {termsSections.map((section) => (
          <article className="landing-panel space-y-3 p-5 md:p-6" key={section.title}>
            <h2 className="type-card">{section.title}</h2>
            <p className="type-body-sm max-w-4xl">{section.text}</p>
          </article>
        ))}
      </div>
    </section>
